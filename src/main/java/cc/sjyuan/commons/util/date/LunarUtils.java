...
public class LunarUtils {
     ...
     * @throws IllegalArgumentException if the month below zero or month above twelve
     */
     ...
     *
     * @param year  solar calendar year
     * @param month solar calendar month
     * @param day   solar calendarday
     * @return the lunar date
     */
