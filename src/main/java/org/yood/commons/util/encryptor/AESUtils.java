...
public class AESUtils {
    ...
    public static String encrypt(String strIn,
                                 String encryptKey) throws InvalidKeyException, InvalidAlgorithmParameterException,
														   IllegalBlockSizeException, BadPaddingException,
														   UnsupportedEncodingException, NoSuchAlgorithmException,
														   NoSuchPaddingException {
        IvParameterSpec zeroIv = new IvParameterSpec(PARAM_SPEC.getBytes());
        SecretKeySpec key = new SecretKeySpec(encryptKey.getBytes(ENCODING_ISO_8859_1), ALGORITHM);
    ...
    public static String decrypt(String strIn,
                                 String decryptKey) throws NoSuchAlgorithmException, NoSuchPaddingException,
														   InvalidKeyException, InvalidAlgorithmParameterException,
														   IllegalBlockSizeException, BadPaddingException,
														   UnsupportedEncodingException {
        byte[] byteMi = decode(strIn);
        IvParameterSpec zeroIv = new IvParameterSpec(PARAM_SPEC.getBytes());
        SecretKeySpec key = new SecretKeySpec(decryptKey.getBytes(ENCODING_ISO_8859_1), ALGORITHM);
        Cipher cipher = Cipher.getInstance("AES/CBC/PKCS5Padding");
    ...
    public static byte[] decode(String s) {
        ...
        try {
            ...
            throw new RuntimeException("Error while decoding BASE64: " + e.toString());
        }
    }
