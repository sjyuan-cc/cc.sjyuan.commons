...
import org.yood.commons.util.jdbc.config.EJdbcConnectity;
import org.yood.commons.util.jdbc.config.JDBCProperties;
import org.yood.commons.util.jdbc.config.JDBCProperties.Connectity;
...
public abstract class JdbcMgr {
	...
	public Connection resetConnection(JDBCProperties jdbcProperties) {
		Connectity connectity = jdbcProperties.buildConnectity();
